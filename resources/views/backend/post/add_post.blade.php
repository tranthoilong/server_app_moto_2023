                ...
                <div class="page-title-box">
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="javascript: void(0);">Thêm bài viết</a></li>
                    ...
                    <div class="card-body">
                        ...
                        <div class="tab-pane" id="settings">
                            <form method="post" action="{{ route('post.store') }}" enctype="multipart/form-data">
                                ...
                                <h5 class="mb-4 text-uppercase"><i class="mdi mdi-account-circle me-1"></i>Thêm bài viết</h5>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" id="title" name="title" class="form-control @error('title') is-invalid @enderror" onkeyup="createSlug()"  >
                                            @error('title')
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <textarea id="short_description" name="short_description" class="form-control ckeditor"></textarea>
                                        </div>
                                    </div>
