...
<div class="row">
    <div class="col-lg-4 col-xl-4">
        <div class="card text-center">
            <div class="card-body">
                <img src="{{ (!empty($adminData->image)) ? Storage::url('user/'.$adminData->image) : url('upload/no_image.jpg') }}" class="rounded-circle avatar-lg img-thumbnail"
                alt="profile-image">
                ...
                <div class="text-start mt-3">
                    ...
                    <p class="text-muted mb-2 font-13"><strong>Tên người dùng :</strong> <span class="ms-2">{{ $adminData->name }}</span></p>

                    <p class="text-muted mb-2 font-13"><strong>Số điện thoại :</strong><span class="ms-2">{{ $adminData->phone }}</span></p>
...
<div class="mb-3">
    ...
    <img id="showImage" src="{{ (!empty($adminData->image)) ? Storage::url('user/'.$adminData->image) : url('upload/no_image.jpg') }}" class="rounded-circle avatar-lg img-thumbnail">
